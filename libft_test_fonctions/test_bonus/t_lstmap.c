...
void    t_lstmap_u(t_list *lst, void *(*f)(void *))
{
    t_list  *temp = lst;
    ...
    printf("\nlist after:\n");
    t_list *new = ft_lstmap(lst, f, free);
    temp = lst;
    ft_printlst(temp);
    printf("\nnew list:\n");
    ft_printlst(new);
...
void t_lstmap(void)
{
    ...
    t_lstmap_u(NULL, NULL);
    t_lstmap_u(NULL, &ft_numbertoletter);
    t_lstmap_u(lst4, &ft_numbertoletter);
    t_lstmap_u(lst1, NULL);
    t_lstmap_u(lst1, &ft_strzgzgzgh);
